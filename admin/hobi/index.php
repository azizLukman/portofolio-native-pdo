...
// Ambil data hobi
$query = mysqli_query($conn, "SELECT * FROM hobi ORDER BY nama_hobi ASC");
?>
...
<head>
    ...
    <title>Dashboard Admin - Manajemen Hobi</title>
    ...
    <style>
        ...
        .btn-gradient-add {
            ...
            text-decoration: none; box-shadow: 0 4px 15px rgba(139, 92, 246, 0.3);
            transition: all 0.2s ease; display: inline-block;
        }
        .btn-gradient-add:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(139, 92, 246, 0.5); color: white; }
    ...
    <div class="container-fluid px-2">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <div class="nav-menu my-3 my-lg-0">
                ...
                <a href="../hobi/index.php" class="active">Hobi</a>
...
<div class="container main-content">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
        <div>
            <div class="text-primary fw-bold small mb-1"><i class="fa-solid fa-heart me-2"></i>MODUL PERSONAL</div>
            <h1 class="fs-2 fw-bold m-0 text-white">MINAT & <span class="gradient-text">HOBI</span></h1>
        </div>
        <div>
            <a href="tambah.php" class="btn-gradient-add">
                <i class="fa-solid fa-plus me-2"></i>Tambah Hobi Baru
            </a>
        </div>
    </div>
            ...
            <table class="table table-premium text-nowrap">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><div class="fw-bold text-white"><?= htmlspecialchars($data['nama_hobi'] ?? '-') ?></div></td>
                            <td class="text-muted text-wrap" style="white-space: normal; max-width: 300px;"><?= htmlspecialchars($data['deskripsi'] ?? '-') ?></td>
                            <td class="text-center fs-4"><i class="<?= htmlspecialchars($data['ikon'] ?? 'fa-solid fa-star') ?>"></i></td>
                            <td class="text-center">
                              <?php 
    // GANTI 'id_hobi' dengan nama kolom asli dari database kamu
    $id_data = $data['id_hobi']; 
    ...
    echo '<a href="proses.php?aksi=hapus&id=' . $id_data . '" class="btn-action bg-danger bg-opacity-20 text-danger border border-danger border-opacity-20" title="Hapus" onclick="return confirm(\'Yakin hapus hobi ini?\')"><i class="fa-solid fa-trash-can"></i></a>';
?>
                            </td>
                        </tr>
                    <?php 
                    ...
                    ?>
                        <tr>
                            <td colspan="5" class="text-center py-5 text-muted">
                                <i class="fa-solid fa-heart-broken fs-2 d-block mb-3 text-secondary"></i>
                                Belum ada data hobi yang ditambahkan.
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
