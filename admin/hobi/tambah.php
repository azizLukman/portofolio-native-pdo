    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="glass-card">
                <h3 class="mb-4">Tambah <span class="gradient-text">Hobi Baru</span></h3>
                <form action="proses.php?aksi=tambah" method="POST">
                    <div class="mb-3">
                        <label class="form-label">Nama Hobi</label>
                        <input type="text" name="nama_hobi" class="form-control" required placeholder="Contoh: Coding, Fotografi">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Deskripsi Singkat</label>
                        <textarea name="deskripsi" class="form-control" rows="3" required placeholder="Jelaskan hobi Anda..."></textarea>
                    </div>
                    <div class="mb-4">
                        <label class="form-label">Ikon (FontAwesome)</label>
                        <input type="text" name="ikon" class="form-control" required placeholder="Contoh: fa-solid fa-code">
                        <small class="text-muted mt-1 d-block">Gunakan format FontAwesome (e.g. fa-solid fa-camera)</small>
                    </div>
                    <button type="submit" class="btn btn-submit w-100 rounded-pill">Simpan Hobi</button>
