...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-6 glass-card">
            <h3 class="fw-bold mb-4">Tambah <span class="gradient-text">Proyek</span></h3>
            <form action="proses.php?aksi=tambah" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tech_stack" class="form-control" placeholder="Contoh: PHP, MySQL, Bootstrap" required>
                </div>
                <div class="mb-4">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-gradient flex-grow-1"><i class="fa-solid fa-save me-2"></i>Simpan</button>
