...
$query = mysqli_query($conn, "SELECT * FROM kontak WHERE id_kontak = '$id'");
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="glass-card">
                <h3 class="mb-4">Edit <span class="gradient-text">Kontak</span></h3>
                ...
                <form action="proses.php?aksi=edit" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="nama" class="form-select" required>
                            <?php 
                            $opsi = ['WhatsApp', 'Instagram', 'TikTok', 'YouTube', 'Email', 'GitHub', 'LinkedIn'];
                            foreach($opsi as $o) {
                                $selected = ($data['nama'] == $o) ? 'selected' : '';
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-save mb-2">Update Kontak</button>
